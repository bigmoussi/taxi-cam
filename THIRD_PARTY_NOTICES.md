...
| --- | --- | --- |
| ReShade 6.8.0 | Legacy prototype only; absent from the native companion and bridge | [ReShade notice](licenses/ReShade.txt) |
| Dear ImGui 1.92.5 | Legacy overlay only; absent from the native build | [Dear ImGui notice](licenses/Dear-ImGui.txt) |
