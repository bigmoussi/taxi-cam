...
// Historical fixed-location evidence for the read-only diagnostic tools.
// Production discovery uses camera_contract.hpp and does not consult this
// manifest. These ranges alone never authorize a native call.
...
// Historical loaded-code fingerprints supplied by verified_profile.cpp for
// offline comparisons. Neither file is linked into the production bridge.
