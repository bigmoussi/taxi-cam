...
& $Compiler @taskCommon '-DTAXI_RENDER_BOUNDARY_VALIDATION' (Join-Path $taskRoot 'validation/render_boundary_observer_test.cpp') `
  (Join-Path $taskRoot 'engine-hook/render_boundary_observer.cpp') '-static' '-o' $taskExecutable
