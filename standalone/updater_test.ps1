...
$release.assets += [pscustomobject]@{ name='SHA256SUMS.txt'; state='uploaded'; size=100; browser_download_url='https://github.com/rthomson83/380-taxi-cam/releases/download/v0.8.0-build.12/SHA256SUMS.txt' }
$selected = Select-UpdateAsset $release $current
