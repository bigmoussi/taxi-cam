...
- **Aerosoft A340-600** — nose and tail cameras on the captain's PFD, the first officer's display and the lower ECAM, controlled by the **CAM CAPT**, **CAM F/O** and **CAM SD** selectors (or **Ctrl + Shift + D** for the SD). The F/O and SD displays were confirmed in the simulator; the captain's display was moved one position after that test and is not yet re-checked.
