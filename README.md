...
On the Airbus aircraft, each display first shows a black **PLEASE WAIT** page for 1.5 seconds, in the ground-speed colour, and then the cameras. The page also returns while the camera image is missing or more than a second old. The PMDG 777 does not use it.
